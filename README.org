...
- [[#installation-instructions][INSTALLATION INSTRUCTIONS]]
  ...
  - [[#make-the-following-directories][Make the following directories]]
  - [[#cloning-repos--wallpapers-crucial][Cloning repos + Wallpapers (CRUCIAL)]]
  - [[#launch-emacs-and-set-it-up][Launch emacs and set it up]]
  - [[#clone-this-repo-and-change-to-it][Clone this repo and change to it]]
  - [[#open-readmeorg-in-emacs-and-tangle-the-files][Open README.org in emacs and tangle the files]]
  - [[#make-the-following-files-executable][Make the following files executable]]
  - [[#reboot][Reboot]]
...
#!/usr/bin/env bash
chosen=$(printf "Shutdown\nReboot" | rofi -dmenu -i -p "whatcha wanna do?" -theme-str `@import "~/.config/rofi/themes/material.rasi "`)
case "$chosen" in
...
** Plugins 
=init.lua= file for the plugins that I just like having, although I use emacs. 
...
*** Maybe like an ML4W fork, but better. . + Cross Platform. Yes, these dots will come to Windows, macOS, Android and more. Just like how some people did it with their dots. 
...
** Cloning repos + Wallpapers (CRUCIAL)
Do the following commands
#+begin_src bash
cd ~
git clone --branch waybar_ultimate_rework https://github.com/HyDE-Project/HyDE
...
** Open README.org in emacs and tangle the files
